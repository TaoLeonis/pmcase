package com.taoleonis.pmcase.web.caselist;
...
import com.taoleonis.pmcase.domain.UserDetails;
import com.taoleonis.pmcase.service.CaselistService;
import com.taoleonis.pmcase.service.TaskService;
import com.taoleonis.pmcase.service.TaskcaseService;
...
public class CaselistController {
    ...
    public String newCaselist(@Valid CaselistForm form, BindingResult result) {
        ...
        caselist.setCreatetime(new Timestamp(new Date().getTime()));
        caselist.setUpdatetime(new Timestamp(new Date().getTime()));
